      ...
      <div className="sidebar min-w-[250px] bg-white border-solid border-r-[1px] border-r-[#E3E3E3] h-full">
        ...
        <div className="flex flex-col py-3 px-[27px] justify-center">
          <div className="pb-9 mb-5 border-b-[#E3E3E3] border-b-[1px]">
            <div
              className={`rounded-[4px] hover:border-l-[#3DB5E6] hover:text-[#3DB5E6] hover:bg-[#F5F8FE]  border-solid ${
          ...
          <div
            ...
            } border-solid hover:border-l-[3px] border-l-transparent text-[#A9A9A9] hover:border-l-[#3DB5E6] hover:text-[#3DB5E6] hover:bg-[#F5F8FE] flex items-center transition-all delay-500 py-[9px]`}
          >
          ...
          <div
            className={`rounded-[4px] my-1 border-solid hover:border-l-[3px] hover:border-l-[#3DB5E6] border-l-transparent text-[#A9A9A9] hover:text-[#3DB5E6] hover:bg-[#F5F8FE] flex items-center transition-all delay-500 py-[9px] ${
              pathname.indexOf("") !== -1 ? active : ""
            }`}
          >
          ...
          <div
            className={`rounded-[4px] my-1 border-solid hover:border-l-[3px] hover:border-l-[#3DB5E6] hover:text-[#3DB5E6] border-l-transparent text-[#A9A9A9] hover:bg-[#F5F8FE] flex items-center transition-all delay-500 py-[9px] ${
              pathname.indexOf("") !== -1 ? active : ""
            }`}
          >
          ...
          <div className="rounded-[4px] my-1 border-solid hover:border-l-[3px] hover:border-l-[#3DB5E6] border-l-transparent text-[#A9A9A9] hover:text-[#3DB5E6] hover:bg-[#F5F8FE] flex items-center transition-all delay-500 py-[9px]">
