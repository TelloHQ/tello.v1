  ...
  return (
    <div className="mx-[30px] mt-24 px-14 2md:px-4 2md:mx-1" id="about">
      <div className="w-[320px]">
        <span className="uppercase text-[#3DB5E6] font-semibold text-[14px]">
          receive tips daily
        </span>
      ...
      <div className="rounded-[14px] mt-[6rem] bg-contain h-[386px] bg-no-repeat m-auto max-w-[800px] bg-donation bg-[rgba(0,0,0,0.5)] bg-blend-color flex flex-col justify-center items-center">
        ...
        <button
          onClick={login}
          className="text-sm mmd:mt-10 hover:bg-[#2D9CDB] transition-all delay-500 rounded-[6rem] bg-[#3DB5E6] mt-20 mx-auto justify-self-center place-self-center object-center text-white font-normal py-[14px] px-8"
        >
          Connect Wallet
        </button>
      </div>
